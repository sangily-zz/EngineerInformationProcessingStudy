...
- [0. 정보처리기사 필기 공부계획 및 내용정리](#0----------------------)
  * [1) 목차](#1----)
  * [2) 공부법](#2-----)
- [1. 소프트웨어 설계](#1---------)
  * [1) 요구사항 확인](#1---------)
    + [[1] 소프트웨어 생명 주기(Software Life Cycle)](#-1--------------software-life-cycle-)
    + [[2] 소프트웨어 공학](#-2----------)
  * [2) 스크럼(Scrum) 기법](#2------scrum----)
    + [[1] 개념](#-1----)
    + [[2] 스크럼 팀의 구성원](#-2------------)
    + [[3] 스크럼 개발 프로세스](#-3-------------)
- [주석](#--)
...
- 일반적으로 사용되는 모형은 다음과 같다.
  ...
  > > - 두 개 이상의 **과정 병행 X**
  >
  > <img src="https://user-images.githubusercontent.com/76988389/127743912-f7e7792e-2d15-4620-babb-646bb30e3fd5.png" width="50%" height="50%">
  ...
  >
  > <img src="https://user-images.githubusercontent.com/76988389/127743956-267cc228-4949-46fe-9c83-a5ba169d7dff.png" width="20%" height="20%">
...
>
> <img src="https://user-images.githubusercontent.com/76988389/127743963-6c4bd2e6-a997-4394-91d8-b191ff82ec56.png" width="20%" height="20%">
...
>
> <img src="https://user-images.githubusercontent.com/76988389/127743970-32aeee2e-da79-4b3b-a205-d512f6b8c487.png" width="50%" height="50%">
...
>
> > - **이해관계자**<sup>[1](#1)</sup> 들 중 **개발될 제품에 대한 이해도**가 높고, **요구사항을 책임지고 의사 결정**할 사람으로 선정하는데, 주로 개발 의뢰자나 사용자가 담당한다.
> > - 이해관계자의 의견을 종합하여 **제품에 대한 요구사항(백로그(Backlog)<sup>[2](#2)</sup>)을 작성하는 주체**이다.
> > - **팀원**은 백로그에 **스토리**<sup>[3](#3)</sup> 를 추가할 수는 있지만 **우선순위를 지정할 수는 없다.**
...
<a name="1">이해관계자</a>: 개발 의뢰자, 개발자, 사용자 등.  
<a name="2">백로그</a>: 제품 개발에 필요한 요구사항을 모두 모아 우선순위를 부여해 놓은 목록  
<a name="3">스토리</a>: 백로그에 담겨질 요구사항. 단어 형태가 아닌, '고객은 상품 주문을 위해 로그인을 수행해야 한다'와 같이 서술하는 형태로 표현하기 때문에 스토리, 또는 사용자 스토리라고 칭함.  
